...
- (void)viewDidLoad
{
    ...
    UIBarButtonItemAdditions *leftItemBtn = [[UIBarButtonItemAdditions alloc] initWithMyMethodTitle:@"  返回" img:@"item_btn_back_bk" target:self action:@selector(backToTandH) font:10];
    self.navigationItem.leftBarButtonItem = leftItemBtn;

    
    UIGridView *tableView = [[UIGridView alloc] initWithFrame:
                             CGRectMake(20, 20, 320, 440)];
