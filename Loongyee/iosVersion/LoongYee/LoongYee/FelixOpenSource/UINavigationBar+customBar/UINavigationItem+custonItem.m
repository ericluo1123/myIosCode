...
- (void) setTitle:(NSString*)title{  
    ...
    UIView * customTitleView = [[UIView alloc] initWithFrame:CGRectMake(0.0f, 2.0f, 150.0f, 40.0f)];
    
    UILabel * customLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, 5.0f, 150.0f, 30.0f)];
