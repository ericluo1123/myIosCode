...
@property (strong, nonatomic) id<DLDataPickerDataSource> dataSource;
@property (strong, nonatomic) id<DLDataPickerDelegate> delegate;
...
- (void)configDelegate:(id)delegate Method:(SEL)sel implementation:(IMP)imp
{
    ...
    NSMutableString *encodingString;
...
- (void)configUI
{
    ...
    _toolBar = [[UIToolbar alloc] initWithFrame:CGRectMake(0, 0, windowFrame.size.width, kToolBarHeight)];
